    ...
    public Bitmap daInfoBmp() {
        ...
        try {
            ...
            if (labelType_ != null && labelType_.equals("PR")) {
                data_ = macid_ + ";" + model_ + ";" + ver_ + ";" + project_ + ";" + power_ + ";" + labelType_ + ";" + date_ + ";" + id_+slic;
                qr = createQRCode(macid_ + ";" + model_ + ";" + ver_ + ";" + project_ + ";" + power_ + ";" + labelType_ + ";" + date_ + ";" + id_+slic, infoPosition_[2]);
            } else {
                data_ = macid_ + ";" + model_ + ";" + ver_ + ";" + project_ + ";" + power_ + ";" + labelType_ + ";" + softwareVer_ + ";" + id_+slic;
                qr = createQRCode(macid_ + ";" + model_ + ";" + ver_ + ";" + project_ + ";" + power_ + ";" + labelType_ + ";" + softwareVer_ + ";" + id_+slic, infoPosition_[2]);
            }
        } catch (Exception ex) {
        }
        if (qr == null) {
