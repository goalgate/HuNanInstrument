...
public class SXRegActivity extends RxActivity implements IFaceView, IIDCardView {
...
//    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        disposableTimer = RxTextView.textChanges(tv_timer)
                ...
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe((charSequence) -> fp.PreviewCease(() -> SXRegActivity.this.finish()));
    ...
    public void onsetICCardInfo(ICardInfo cardInfo) {
        if (cardInfo.getUid().equals(AppInit.The_IC_UID)) {
            fp.PreviewCease(() -> SXRegActivity.this.finish());
        } else {
    ...
    private void faceUpload() {
        ...
        RetrofitGenerator.getSxApi().faceUpload("faceUpload", paramsMap.get("daid"), paramsMap.get("pass"), jsonObject.toString())
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
