...
public class YZBYPT_MainActivity extends BaseActivity implements SuperWindow.OptionTypeListener {
    ...
    public void onSuperOptionType(Button view, int type) {
        ...
        if (type == 1) {
            ...
            new AlertView("设备信息同步", null, "取消", new String[]{"确定"}, null, YZBYPT_MainActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                @Override
            ...
            new AlertView("删除人员指纹信息", null, "取消", new String[]{"确定"}, null, YZBYPT_MainActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                @Override
                public void onItemClick(Object o, int position) {
                    if (position == 0) {
    ...
    public void onFpSucc(final String msg) {
        Alarm.getInstance(this).doorAlarm(new Alarm.doorCallback() {
            ...
            @Override
            public void onSucc() {
                Alarm.getInstance(YZBYPT_MainActivity.this).networkAlarm(network_state, new Alarm.networkCallback() {
                    @Override
                    ...
                    @Override
                    public void onTextBack(String msg) {
                        Alarm.getInstance(YZBYPT_MainActivity.this).setKnown(true);
                        tv_info.setText(msg);
                    }
                });
            }
