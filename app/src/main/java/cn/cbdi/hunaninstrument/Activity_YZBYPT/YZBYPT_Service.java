package cn.cbdi.hunaninstrument.Activity_YZBYPT;
...
public class YZBYPT_Service extends Service implements ISwitchView {
        ...
        if (config.getBoolean("CopySourceFileVer1", true)) {
            Observable.create((emitter) -> {
                emitter.onNext(ApkUtils.copyfile(
                        new File(ApkUtils.getSourceApkPath(YZBYPT_Service.this, UpdateConstant.TEST_PACKAGENAME)),
