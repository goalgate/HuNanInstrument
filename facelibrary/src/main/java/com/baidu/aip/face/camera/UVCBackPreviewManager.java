...
public class UVCBackPreviewManager implements TextureView.SurfaceTextureListener {
    Handler handler;
    Object Sync;
...
//    private Camera mCamera;
    ...
    private static volatile UVCBackPreviewManager instance = null;
...
//        ORIENTATIONS.append(Surface.ROTATION_270, 180);
    ...
    public static UVCBackPreviewManager getInstance() {
        if (instance == null) {
            synchronized (UVCBackPreviewManager.class) {
                if (instance == null) {
                    instance = new UVCBackPreviewManager();
                }
            }
        }
        return instance;
    ...
    public void stopPreview() {
        if (mUVCCamera != null) {
            try {
                ...
                mSurfaceCreated = false;
                mTextureView = null;
                mUVCCamera.setFrameCallback(null, PixelFormat.RGB_888);
                mUVCCamera.stopPreview();
                mUVCCamera.close();
                mUVCCamera.destroy();
                mUVCCamera = null;
    ...
    public void uvcCameraStartPreview() {
