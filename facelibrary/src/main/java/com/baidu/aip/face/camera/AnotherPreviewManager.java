...
public class AnotherPreviewManager implements TextureView.SurfaceTextureListener {
    ...
    private static volatile AnotherPreviewManager instance = null;
...
//        ORIENTATIONS.append(Surface.ROTATION_270, 180);
    ...
    public static AnotherPreviewManager getInstance() {
        if (instance == null) {
            synchronized (AnotherPreviewManager.class) {
                if (instance == null) {
                    instance = new AnotherPreviewManager();
                }
            }
        }
        return instance;
